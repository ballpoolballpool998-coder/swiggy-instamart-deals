...
javascript:(async () => {
  ...
  const CONFIG = {
    ...
    queries: [
      ...
      { query: "Dairy, Bread & Eggs", type: "essential" },
      { query: "Milk", type: "essential" },
      { query: "Curd & Yoghurt", type: "essential" },
      { query: "Butter & Cheese", type: "essential" },
      { query: "Paneer & Cream", type: "essential" },
      { query: "Atta, Rice & Dals", type: "essential" },
      { query: "Oil & Ghee", type: "essential" },
      { query: "Masala", type: "essential" },
      { query: "Fruits and Vegetables", type: "essential" },
      { query: "Seasonings", type: "essential" },
      { query: "Cleaning Essentials", type: "essential" },
      { query: "Detergents", type: "essential" },
      { query: "Dishwash", type: "essential" },
      { query: "Toilet Cleaner", type: "essential" },
      { query: "Personal Care", type: "essential" },
      { query: "Bath & Body", type: "essential" },
      ...
      { query: "Snacks+Munchies", type: "treats" },
      { query: "Biscuits & Cookies", type: "treats" },
      { query: "Cold Drinks & Juices", type: "treats" },
      { query: "Cake", type: "treats" },
      { query: "Tea", type: "treats" },
      { query: "Coffee", type: "treats" },
      { query: "Instant Food", type: "treats" },
      { query: "Chocolates & Ice Creams", type: "treats" },
      { query: "Dry Fruits & Cereals", type: "treats" },
